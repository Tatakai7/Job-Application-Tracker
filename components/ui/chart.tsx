...
// Add CSS styles component for the chart indicators
const ChartCSSStyles = () => (
  <style
    dangerouslySetInnerHTML={{
      __html: `
        .chart-indicator-dot {
        ...
        [data-legend-color] {
          --legend-color: attr(data-legend-color);
        }
      `,
    }}
  />
...
// Add CSS classes for the indicator styles
const indicatorClasses = {
  dot: 'chart-indicator-dot',
  line: 'chart-indicator-line',
  dashed: 'chart-indicator-dashed',
};
